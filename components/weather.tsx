...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-blue-900 text-white">
      {/* Display your name at the top */}
      <h1 className="text-3xl font-bold mb-4">Mohsin Raza</h1>

      {/* Center the card within the screen */}
      <Card className="w-full max-w-md mx-auto text-center bg-gray-700">
